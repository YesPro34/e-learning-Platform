...
export default function programminPage() {
    const courses = getCourses()
    const frontEndCourses = courses.filter(item => item.type == "programming-langauge")

  return (
    <Box>
      <Box mb={4}>
          <Typography variant="h1">Programming Languages Courses</Typography>
      </Box>
